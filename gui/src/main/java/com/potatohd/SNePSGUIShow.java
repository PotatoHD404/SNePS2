...
public class SNePSGUIShow extends javax.swing.JFrame {
	...
	pr.setVertexPaintFunction(new com.potatohd.SNePSNodeColorFunction());
	pr.setVertexShapeFunction(new com.potatohd.SNePSNodeShapeFunction());
	...
	vv.setToolTipFunction(new com.potatohd.SNePSGUIToolTipFunction());
