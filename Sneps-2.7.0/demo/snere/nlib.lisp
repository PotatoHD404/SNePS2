...
;; Version: $Id: nlib.lisp,v 1.3 2007/08/21 01:54:17 mwk3 Exp $
...
; *** End of new stuff.
  (if (equal (length (return-all-mentioned-variables)) 1)
	...
	(eval
	  `(build object ,varnode
		  property  "former"))))
  (if (lisp:> (length (return-all-mentioned-variables)) 2)
