...
public class BipartiteGraphCollapser extends GraphCollapser {
	...
	/**
	 * @see edu.uci.ics.jung.graph.algorithms.blockmodel.GraphCollapser#addUndirectedEdge(Graph, Vertex, Vertex, Set)
	 */
	 ...
	 * @see edu.uci.ics.jung.graph.algorithms.blockmodel.GraphCollapser#getCollapsedVertex(Graph, Set)
	 */
